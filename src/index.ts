...
// letters in the key word
 export const findWords = (keyWord: string, wordArray: string[]): string[] => {
...
const areLettersInString = (keyWord: string, currentWord: string): boolean => {
...
const charFrequency = (word: string, char: string): number => {
    let charCount = 0;
...
console.log(findWords("ate", ["a", "eat", "tea", "dog", "do", "god", "goo", "go", "good"]));
